...
public class SessionJpaEntity {
    ...
    @Column(name = "slide_storage_path")
    private String slideStoragePath;

    @Column(name = "slide_original_filename")
    ...
    public String getSlideStoragePath() {
        return slideStoragePath;
    }

    public void setSlideStoragePath(String slideStoragePath) {
        this.slideStoragePath = slideStoragePath;
    }

    public String getSlideOriginalFilename() {
        return slideOriginalFilename;
    }

    public void setSlideOriginalFilename(String slideOriginalFilename) {
        this.slideOriginalFilename = slideOriginalFilename;
    }
    ...
    public Long getSlideSizeBytes() {
        return slideSizeBytes;
    }

    public void setSlideSizeBytes(Long slideSizeBytes) {
        this.slideSizeBytes = slideSizeBytes;
    }
