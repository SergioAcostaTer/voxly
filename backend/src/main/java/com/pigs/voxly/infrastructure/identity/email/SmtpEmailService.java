...
public class SmtpEmailService implements EmailService {
    ...
    @Override
    public void sendAnalysisCompleted(String to, String username, String sessionTitle, String sessionUrl) {
        String body = """
                <h2>Your VoxLy analysis is ready</h2>
                <p>Hi %s, your session <strong>%s</strong> has finished processing.</p>
                <p>You can review the transcript, metrics, and coaching feedback here:</p>
                <p><a href="%s">Open session review</a></p>
                <p>Keep practicing. Your next improvement is usually in the replay.</p>
                """.formatted(username, sessionTitle, sessionUrl);

        sendHtmlEmail(to, "Your VoxLy analysis is ready", body);
    }
