...
public class EvaluationJpaEntity {
    ...
    @Column(name = "posture_grade", length = 10)
    private String postureGrade;

    @Column(name = "posture_gesture_summaries_json", columnDefinition = "TEXT")
    private String postureGestureSummariesJson;

    @Column(name = "posture_timeline_json", columnDefinition = "TEXT")
    private String postureTimelineJson;

    @Column(name = "posture_penalty_breakdown_json", columnDefinition = "TEXT")
    private String posturePenaltyBreakdownJson;

    @Column(name = "posture_recommendations_json", columnDefinition = "TEXT")
    private String postureRecommendationsJson;

    @Column(name = "posture_rendered_video_url", columnDefinition = "TEXT")
    ...
    public String getPostureGrade() { return postureGrade; }
    public void setPostureGrade(String postureGrade) { this.postureGrade = postureGrade; }

    public String getPostureGestureSummariesJson() { return postureGestureSummariesJson; }
    public void setPostureGestureSummariesJson(String json) { this.postureGestureSummariesJson = json; }

    public String getPostureTimelineJson() { return postureTimelineJson; }
    public void setPostureTimelineJson(String json) { this.postureTimelineJson = json; }

    public String getPosturePenaltyBreakdownJson() { return posturePenaltyBreakdownJson; }
    public void setPosturePenaltyBreakdownJson(String json) { this.posturePenaltyBreakdownJson = json; }

    public String getPostureRecommendationsJson() { return postureRecommendationsJson; }
    public void setPostureRecommendationsJson(String json) { this.postureRecommendationsJson = json; }

    public String getPostureRenderedVideoUrl() { return postureRenderedVideoUrl; }
    public void setPostureRenderedVideoUrl(String url) { this.postureRenderedVideoUrl = url; }
