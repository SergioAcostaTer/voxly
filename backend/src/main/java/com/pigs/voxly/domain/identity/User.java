...
public final class User extends AggregateRoot<UserId> {
    ...
    public static User reconstitute(UserId id, Email email, Username username, PasswordHash passwordHash,
                                    ...
                                    String professionalRole, String coachingFocus,
        ...
        user.coachingFocus = coachingFocus;
    ...
    public Result updateProfessionalProfile(String professionalRole, String coachingFocus) {
        this.professionalRole = normalizeProfileField(professionalRole, 100);
        this.coachingFocus = normalizeProfileField(coachingFocus, 500);
        markModified();
        return Result.success();
    }
