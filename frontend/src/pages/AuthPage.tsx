...
export function AuthPage({ mode }: AuthPageProps) {
  ...
  useEffect(() => {
    if (!AUTH_BYPASS_ENABLED || isLoading || !isAuthenticated) {
      return
    }
  ...
  async function handleSendTwoFactorCode() {
    ...
    try {
      await api.requestTwoFactorCode(identifier, password)
          ...
          <Card className="bg-white/90 p-6 sm:p-8 lg:p-10">
            ...
            <form className="mt-7 space-y-5" onSubmit={handleSubmit}>
              ...
              {!isLogin ? (
                <>
                  <label className="block space-y-1.5">
                    <span className="text-base font-medium">Professional role</span>
                    <Input
                  ...
                  <label className="block space-y-1.5">
                    <span className="text-base font-medium">Coaching focus</span>
                    <Input
                ...
                <label className="block space-y-1.5">
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row">
                    ...
                    <Button
                      variant="secondary"
                      className="shrink-0"
                      disabled={isSendingCode || !identifier || !password}
            ...
            <div className="mt-6 grid gap-2 sm:grid-cols-2">
              <a href={api.getOAuthLoginUrl('google')}>
                <Button variant="secondary" className="w-full">
                  Google
                </Button>
              </a>
              <a href={api.getOAuthLoginUrl('microsoft')}>
                <Button variant="secondary" className="w-full">
                  Microsoft
                </Button>
              </a>
