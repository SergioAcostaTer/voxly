...
public class UserJpaEntity {
    ...
    @Column(name = "professional_role", length = 100)
    private String professionalRole;

    @Column(name = "coaching_focus", length = 500)
    ...
    public String getCoachingFocus() { return coachingFocus; }
    public void setCoachingFocus(String coachingFocus) { this.coachingFocus = coachingFocus; }
