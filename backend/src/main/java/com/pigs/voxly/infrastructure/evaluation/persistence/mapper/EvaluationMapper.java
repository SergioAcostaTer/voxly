...
public class EvaluationMapper {
    ...
    public Evaluation toDomain(EvaluationJpaEntity entity) {
        return Evaluation.reconstitute(
                ...
                entity.getPostureGrade(),
                entity.getPostureGestureSummariesJson(),
                entity.getPostureTimelineJson(),
                entity.getPosturePenaltyBreakdownJson(),
                entity.getPostureRecommendationsJson(),
                entity.getPostureRenderedVideoUrl(),
    ...
    public EvaluationJpaEntity toEntity(Evaluation evaluation) {
        ...
        entity.setPostureScore(evaluation.getPostureScore());
        entity.setPostureGrade(evaluation.getPostureGrade());
        entity.setPostureGestureSummariesJson(evaluation.getPostureGestureSummariesJson());
        entity.setPostureTimelineJson(evaluation.getPostureTimelineJson());
        entity.setPosturePenaltyBreakdownJson(evaluation.getPosturePenaltyBreakdownJson());
        entity.setPostureRecommendationsJson(evaluation.getPostureRecommendationsJson());
        entity.setPostureRenderedVideoUrl(evaluation.getPostureRenderedVideoUrl());
